...
import static com.spring.tdfinaloas_collectivites_agricoles_finale.entity.MemberOccupation.JUNIOR;
...
public class Member {
    ...
    public boolean isUpToDateForActiveFees(List<MembershipFee> activeFees, List<MemberPayment> payments) {
        double totalDue = activeFees.stream()
